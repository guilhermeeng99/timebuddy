...
extension ContextNavigationExtensions on BuildContext {
  ...
  /// is nothing to close.
  ///
  /// Every sub-page in TimeBuddy is URL-addressable on web (`/settings`,
  /// `/locations/add`). When the user opens one of those URLs directly — a
  ...
  ///
  /// ```dart
  /// // Settings: pushed from the shell, or opened cold at /settings.
  /// context.popOrGo(AppRoutes.home);
  ///
  /// // A picker handing a value back to the page that pushed it.
  /// context.popOrGo(AppRoutes.home, result: selectedCity);
  /// ```
